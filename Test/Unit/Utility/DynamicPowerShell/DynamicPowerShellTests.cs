...
namespace Microsoft.PackageManagement.Test.Utility.DynamicPowerShell {
    using PackageManagement.Utility.PowerShell;
    using Xunit;
    using Xunit.Abstractions;
    using Console = Support.Console;

    public class DynamicPowerShellTests : Tests {
        public DynamicPowerShellTests(ITestOutputHelper output)
            : base(output) {

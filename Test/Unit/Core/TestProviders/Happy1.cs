    ...
    // add this if you want to 'hide' your provider by default.
        ...
        internal void Reset() {
            ...
            availablePackages = new[] {
                new Pkg {
                    ...
                    name = "package1",
                    source = "source1",
                    summary = "this is package 1",
                    version = "1.0",
                    packageFileName = "pkg1.mypkg",
                    fullPath = "",
                ...
                new Pkg {
                    ...
                    name = "package1",
                    source = "source1",
                    summary = "this is package 1 (v1.1)",
                    version = "1.1",
                    packageFileName = "pkg1.mypkg",
                    fullPath = "",
                    versionScheme = "numeric"
                ...
                new Pkg {
                    ...
                    name = "package1",
                    source = "source1",
                    summary = "this is package 1 (v1.2)",
                    version = "1.2",
                    packageFileName = "pkg1.mypkg",
                    fullPath = "",
                    versionScheme = "numeric"
                ...
                new Pkg {
                    ...
                    name = "package2",
                    source = "source1",
                    summary = "this is package 2",
                    version = "1.0",
                    packageFileName = "pkg2.mypkg",
                    fullPath = "",
                    versionScheme = "numeric"
                },
                new Pkg {
                    ...
                    name = "package3",
                    source = "source2",
                    summary = "this is package 3",
                    version = "1.0",
                    packageFileName = "pkg3.mypkg",
                    fullPath = "",
                    versionScheme = "numeric"
                },
            };
            ...
            installedPackages = new[] {
                new Pkg {
                    ...
                    name = "package4",
                    source = "source3",
                    summary = "this is package 4",
                    version = "4.0",
                    packageFileName = "pkg4.mypkg",
                    fullPath = "",
                    versionScheme = "numeric"
                },
            };
        ...
        public void FindPackage(string name, string requiredVersion, string minimumVersion, string maximumVersion, int id, Request request) {
            ...
            availablePackages.Where(each => {
                ...
                return true;
            }).SerialForEach(each => {each.Yield(request, name);});
        }

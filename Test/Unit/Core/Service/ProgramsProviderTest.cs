...
namespace Microsoft.PackageManagement.Test.Core.Service {
    ...
    public class ProgramsProviderTest : BasePmsServiceTests {
        public ProgramsProviderTest(ITestOutputHelper outputHelper)
            : base(outputHelper) {
        }
        ...
        public PackageProvider Provider {
            get {
                if (_provider == null) {
                    var packageProviders = PackageManagementService.SelectProviders("programs", new BasicHostImpl()).ToArray();

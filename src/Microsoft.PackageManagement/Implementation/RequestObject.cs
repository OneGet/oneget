...
namespace Microsoft.PackageManagement.Internal.Implementation
{
    ...
    public abstract class RequestObject : AsyncAction, IRequest, IHostApi
    {
        ...
        public override bool IsCanceled => base.IsCanceled || (CanCallHost && _hostApi.IsCanceled);
        ...
        public IWebProxy WebProxy => CanCallHost ? _hostApi.WebProxy : null;

        public string CredentialUsername => CanCallHost ? _hostApi.CredentialUsername : null;

        public SecureString CredentialPassword => CanCallHost ? _hostApi.CredentialPassword : null;
        ...
        #endregion CoreApi implementation
        ...
        #endregion response api implementation
    }
}
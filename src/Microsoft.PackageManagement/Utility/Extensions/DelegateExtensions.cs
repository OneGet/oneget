...
namespace Microsoft.PackageManagement.Internal.Utility.Extensions
{
    ...
    internal static class DelegateExtensions
    {
        ...
        internal static Delegate CreateEmptyDelegate(this Type delegateType)
        {
            ...
            {
                Type delegateReturnType = delegateType.GetDelegateReturnType();

                DynamicMethod dynamicMethod = new DynamicMethod(string.Empty, delegateReturnType, delegateType.GetDelegateParameterTypes().ToArray());

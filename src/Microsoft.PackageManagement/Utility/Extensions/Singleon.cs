...
namespace Microsoft.PackageManagement.Internal.Utility.Extensions
{
    ...
    internal static class Singleton<TResult>
    {
        ...
        public static int CreateHashCode(object[] keys)
        {
            ...
            int hash = _seeds.Zip(keys, (prime, obj) => prime * (obj == null ? 0 : obj.GetHashCode())).Aggregate((accum, each) => accum + each);
        ...
        public static int CreateHashCode(object primaryKey, object[] keys)
        {
            ...
            int hash = _seeds.Zip(keys, (prime, obj) => prime * (obj == null ? 0 : obj.GetHashCode())).Aggregate((accum, each) => accum + each) + primaryKey.GetHashCode();
        ...
        {
            int hash = CreateHashCode(primaryKey, keys);

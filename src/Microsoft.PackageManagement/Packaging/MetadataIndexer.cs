...
namespace Microsoft.PackageManagement.Internal.Packaging
{
    ...
    public class MetadataIndexer
    {
        ...
        /// </summary>
        public IEnumerable<XName> Keys => _swidtag.Meta.SelectMany(each => each.Attributes.Keys).ReEnumerable();

        /// <summary>
        ///     An enumeration of all the attribute values in this element.
        /// </summary>
        public IEnumerable<string> Values => _swidtag.Meta.SelectMany(each => each.Attributes.Values).ReEnumerable();

...
namespace Microsoft.PackageManagement.Internal.Packaging
{
    ...
    public class AttributeIndexer
    {
        ...
        /// </summary>
        public IEnumerable<XName> Keys => _element.Attributes().Select(each => each.Name).ReEnumerable();

        /// <summary>
        ///     An enumeration of all the attribute values in this element.
        /// </summary>
        public IEnumerable<string> Values => _element.Attributes().Select(each => each.Value).ReEnumerable();

        /// <summary>
        ///     The count of the attributes in this element
        /// </summary>
        public int Count => _element.Attributes().Count();

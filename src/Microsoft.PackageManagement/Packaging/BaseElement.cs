...
namespace Microsoft.PackageManagement.Internal.Packaging
{
    ...
    public class BaseElement
    {
        ...
        internal string ElementUniqueId => _uniqueId ?? (_uniqueId = PathToElement(Element));
        ...
        public string Culture
        {
            get
            {
                string xmlLang = GetAttribute(Iso19770_2.Attributes.XmlLang);
            ...
            internal set => AddAttribute(Iso19770_2.Attributes.XmlLang, value);
        }

        public AttributeIndexer Attributes => _attributeIndexer ?? (_attributeIndexer = new AttributeIndexer(Element));
        ...
        private static XElement FindChildElementViaPath(string parentPath, XElement element, string elementId)
        {
            ...
            {
                string eId = PathToElement(parentPath, each);
                if (elementId == eId)
                {
                    return each;
                }

...
namespace Microsoft.PackageManagement.Internal.Packaging
{
    ...
    public class Entity : BaseElement
    {
        ...
        public IEnumerable<string> Roles
        {
            get
            {
                string attr = GetAttribute(Iso19770_2.Attributes.Role.LocalName);
                if (attr != null)
                {
        ...
        public string Role
        {
            get => GetAttribute(Iso19770_2.Attributes.Role.LocalName);
            internal set => AddAttribute(Iso19770_2.Attributes.Role, value);
        }
        ...
        {
            get => GetAttribute(Iso19770_2.Attributes.Thumbprint.LocalName);
            internal set => AddAttribute(Iso19770_2.Attributes.Thumbprint, value);
        }
        ...
        public string RegId
        {
            get => GetAttribute(Iso19770_2.Attributes.RegId.LocalName);
            internal set => AddAttribute(Iso19770_2.Attributes.RegId, value);
        }

        /// <summary>
        ///     An enumeration of nested metadata for the Entity
        /// </summary>
        public IEnumerable<Meta> Meta => Element.Elements(Iso19770_2.Elements.Meta).Select(each => new Meta(each)).ReEnumerable();
        ...
        internal void AddRole(string role)
        {
            ...
            if (attr != null)
            {
                IEnumerable<string> roles = attr.Split(new[] { ' ' }, StringSplitOptions.RemoveEmptyEntries).ConcatSingleItem(role).Distinct();
                role = roles.JoinWith(" ");
            }

...
[Implementation]
        public string DownloadFile(Uri remoteLocation, string localFilename, Object c) {
        ...
        public void RemovePinnedItemFromTaskbar(string item, Object c) {
            //comment
                ...
                [Implementation]
        public bool CreateShortcutLink(string linkPath, string targetPath, string description, string workingDirectory, string arguments, Object c) {
        ...
        public void RemoveExplorerMenuItem() {
                ...
                [Implementation]
        public bool SetEnvironmentVariable(string variable, string value, int context, Object c) {
            ...
            return true;
                ...
                [Implementation]
        public bool RemoveEnvironmentVariable(string variable, int context, Object c) {
            context = context ?? string.Empty;
        ...
        public void GetSystemBinFolder() {
                ...
                [Implementation]
        public bool CopyFile(string sourcePath, string destinationPath, Object c) {
            if (sourcePath == null) {

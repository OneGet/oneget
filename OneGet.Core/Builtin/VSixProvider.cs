...
namespace Microsoft.OneGet.Builtin {
    ...
    public class VsixProvider {
        ...
        /// </summary>
        internal const string ProviderName = "Vsix";

        private static readonly Dictionary<string, string[]> _features = new Dictionary<string, string[]> {
            {Constants.Features.SupportedExtensions, new[] {"vsix"}},
            {Constants.Features.MagicSignatures, new [] { "504b0304"}}
        };
                ...
                using (var request = requestObject.As<Request>()) {
                    ...
                    switch ((category ?? string.Empty).ToLowerInvariant()) {
                        ...
                        case "source":
                            ...
                            request.YieldDynamicOption( ExampleConstants.FavoriteColorParameter, OptionType.String, false);
                            request.YieldDynamicOption( ExampleConstants.SkipValidationParameter, OptionType.Switch, false);
#endif
                            break;

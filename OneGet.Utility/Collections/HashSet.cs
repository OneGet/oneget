...
namespace Microsoft.OneGet.Collections {
    ...
    public class HashSet<TKey, TValue> : List<KeyValuePair<TKey, TValue>> {
    ...
    public class HashSet<T1, T2, T3, T4> : List<Tuple<T1, T2, T3, T4>> {
        public void Add(T1 p1, T2 p2, T3 p3, T4 p4) {
            Add(new Tuple<T1, T2, T3, T4>(p1, p2, p3, p4));
        }
    }

    public class HashSet<T1, T2, T3, T4, T5> : List<Tuple<T1, T2, T3, T4, T5>> {
